      ...
      <section className="relative overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-[0_24px_80px_-30px_rgba(15,23,42,0.22)]">
        ...
        <div className="relative grid gap-10 px-6 py-8 sm:px-8 sm:py-10 lg:grid-cols-12 lg:px-10 lg:py-14">
          ...
          <div className="lg:col-span-6 lg:pr-4">
            ...
            {/* SEARCH CARD */}
            <div className="mt-8">
              <Card className="overflow-hidden rounded-[1.75rem] border-slate-200/90 bg-white/95 shadow-lg shadow-sky-100/40">
                <CardBody className="space-y-5">
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    <span className="ml-auto hidden text-xs text-slate-500 sm:inline">
                      Linked directly to Create Trip
                    </span>
                  </div>

                  <form onSubmit={handleSearchSubmit} className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
                    <Input
                      label={activeTab === "Hotels" || activeTab === "Stays" ? "Destination" : "From"}
                      placeholder={
                        activeTab === "Hotels" || activeTab === "Stays"
                          ? "City or country"
                          : "City or airport"
                      }
                      value={search.from}
                      onChange={(e) => onSearchChange("from", e.target.value)}
                    />

                    <Input
                      label={activeTab === "Hotels" || activeTab === "Stays" ? "Area" : "To"}
                      placeholder={
                        activeTab === "Hotels" || activeTab === "Stays"
                          ? "Neighborhood, area, or landmark"
                          : "City or airport"
                      }
                      value={search.to}
                      onChange={(e) => onSearchChange("to", e.target.value)}
                    />

                    <Input
                      type="date"
                      label={activeTab === "Flights" ? "Departure" : "Check-in"}
                    ...
                    <Input
                      type="date"
                      label={activeTab === "Flights" ? "Return" : "Check-out"}
                    ...
                    <div className="grid gap-3 sm:col-span-2 sm:grid-cols-3 lg:col-span-3">
                      <Select
                        ...
                        onChange={(e) => onSearchChange("travelers", e.target.value)}
                      >
                      ...
                      {activeTab === "Flights" && (
                        <Select
                          ...
                          onChange={(e) => onSearchChange("tripType", e.target.value)}
                        >
                  ...
                  <div className="grid gap-2 sm:grid-cols-3">
                    {[
                      "Pre-fills Create Trip automatically",
                      "Works for flights, stays, and activities",
                      "Modern platform-style experience",
                    ].map((item) => (
                      <div
                        key={item}
